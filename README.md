...
<p align="center">
    📑 <a href="https://huggingface.co/papers/xxxx.xxxxx" target="_blank">Paper</a> &nbsp&nbsp | &nbsp&nbsp 🌐 <a href="https://specx.github.io/" target="_blank">Project Page</a> &nbsp&nbsp | &nbsp&nbsp 🤗 <a href="https://huggingface.co/collections/bobshunli/specx-67a978e28fd926b56a4f55a2" target="_blank">Released Resources</a> &nbsp&nbsp | &nbsp&nbsp 💾 <a href="https://huggingface.co/datasets/bobshunli/Annoy-PyEdu-Rs" target="_blank">Dataset</a> &nbsp&nbsp | &nbsp&nbsp 📦 <a href="https://github.com/RockyLzy/Annoy-DataSync" target="_blank">Repo</a>  
<br>
...
|Dataset|Link|
|-|-|
|Annoy-PythonEdu-Rs|[🤗](https://huggingface.co/datasets/bobshunli/Annoy-Pyedu-Rs)|
|Annoy-PythonEdu-Rs-Raw|[🤗](https://huggingface.co/datasets/bobshunli/Annoy-PyEdu-Rs-Raw)|
|LCO Benchmark|[🤗](https://huggingface.co/datasets/bobshunli/LCO)|
...
<table>
    ...
    <tr>
        ...
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/qwen2.5-7b-coder_spec_stage1">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/qwen2.5-7b-coder_spec">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/qwen2.5-7b-coder_spec_pp_stage1">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/qwen2.5-7b-coder_spec_pp">🤗</a></td>
    </tr>
    <tr>
        <td>LLaMA 3.1 8B</td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/llama3.1-8b_spec_stage1">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/llama3.1-8b_spec">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/llama3.1-8b_spec_pp_stage1">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/llama3.1-8b_spec_pp">🤗</a></td>
    </tr>
    <tr>
        <td>DeepSeek v2 Lite Coder</td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/dsv2-lite-coder_spec_stage1">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/dsv2-lite-coder_spec">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/dsv2-lite-coder_spec_pp_stage1">🤗</a></td>
        <td style="text-align: center; vertical-align: middle;"><a href="https://huggingface.co/bobshunli/dsv2-lite-coder_spec_pp">🤗</a></td>
    </tr>
</table>
...
We provide a complete guide for you to build data for Annoy on a toy dataset. After all these steps you can get a dataset with the same format as in our [huggingface dataset](https://huggingface.co/datasets/bobshunli/Annoy-Pyedu-Rs).
...
```
By doing so, you can get data `data/spec_demo_final.jsonl` with the same format as in our [huggingface dataset](https://huggingface.co/datasets/bobshunli/Annoy-Pyedu-Rs).
